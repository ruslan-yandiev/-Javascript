...
describe('getSumOfPositiveNumbers', () => {
    ...
    it('getSumOfPositiveNumbers return { sum: 357, count: 5 }', () => {
        ...
        expect(app.getSumOfPositiveNumbers(arr)).to.deep.equal({ sum: 357, count: 5 });
        app.getSumOfPositiveNumbers(arr).should.deep.equal({ sum: 357, count: 5 });
        expect(app.getSumOfPositiveNumbers(arr)).to.deep.include({ sum: 357, count: 5 });
        app.getSumOfPositiveNumbers(arr).should.deep.include({ sum: 357, count: 5 });
    });
